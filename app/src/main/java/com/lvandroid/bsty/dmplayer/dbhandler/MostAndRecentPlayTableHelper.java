...
public class MostAndRecentPlayTableHelper {
    ...
    public static final String AUDIOPROGRESS = "audioProgressSec";
    ...
    public static synchronized MostAndRecentPlayTableHelper getmInstance(Context context) {
        if (mInstance == null) {
    ...
    private void updateStatus_(long count, int musicid) {
