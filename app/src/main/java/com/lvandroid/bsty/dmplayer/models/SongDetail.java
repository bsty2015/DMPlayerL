package com.lvandroid.bsty.dmplayer.models;
...
public class SongDetail {
    ...
    public SongDetail(int id, int album_id, String artist, String title, String display_name, String duration, String path) {
        this.id = id;
        ...
        this.path = path;
        this.duration = TextUtils.isEmpty(duration) ? "0" : String.valueOf(Long.valueOf(duration) / 1000);
    }
